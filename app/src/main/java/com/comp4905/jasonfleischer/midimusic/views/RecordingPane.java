...
public class RecordingPane extends LinearLayout {
    ...
    public void init() {
        ...
        saveBtn = (ImageButton) findViewById(R.id.saving_btn);
        ...
        saveBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (masterTrack == null || masterTrack.getDelayBeforeNextLoop() == null || masterTrack.getSoundIds().isEmpty()) {
                    HLog.i(getResources().getString(R.string.cannot_save_uncomplete));
                } else {
                    SoundManager.getInstance().saveTrack(masterTrack, true);
                    HLog.i(getResources().getString(R.string.trackSaved));
                }
    ...
    public void clearTrack() {
        ...
        SoundManager.publicIds.clear();
        SoundManager.publicTimes.clear();
        statusTextView.setText(getResources().getString(R.string.track_cleared));
        timeTextView.setText(" ");
//        SoundManager.savedVel = null;
//        SoundManager.saveno = 0;
    }
