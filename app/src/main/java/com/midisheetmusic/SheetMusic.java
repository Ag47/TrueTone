...
public class SheetMusic extends SurfaceView implements SurfaceHolder.Callback {
     ...
     */
    private int scrollY;
    private int startMotionX;
    /**
     * The x pixel when a touch motion starts
     */
    ...
    /**
     * The change in x-pixel of the last motion
     */
     ...
     * starttime.
     */
    private void AlignSymbols(ArrayList<ArrayList<MusicSymbol>> allsymbols, SymbolWidths widths) {
